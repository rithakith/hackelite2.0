...
const CountdownTimer = ({ targetDate }: { targetDate: string }) => {
  ...
  return (
    <section className="w-full min-h-[40vh] flex items-center justify-center py-20">
      {" "}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
          {Object.entries(timeLeft).map(([key, value]) => (
            <div key={key} className="flex flex-col items-center">
              <div className="w-24 h-24 flex items-center justify-center bg-gradient-to-br from-[#a280ec]/10 via-[#b146e4]/10 to-[#18d6ed]/10 rounded-xl backdrop-blur-md border border-white/10 hover:border-[#b146e4]/50 transition-all duration-300 shadow-lg hover:shadow-[#a280ec]/20">
